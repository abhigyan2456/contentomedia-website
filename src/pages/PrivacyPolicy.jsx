...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Contentora Media</title>
      </Helmet>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
            ...
            <div className="mb-8" data-aos="fade-up" data-aos-delay="100">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                ...
                , which also provides the reasons why we must collect certain personal data about
            ...
            <section className="mb-8" data-aos="fade-up" data-aos-delay="300">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                ...
                individual. If, however, you wish to use some of the website's features, or you wish
                to receive our newsletter or provide other details by filling a form, you may
                provide personal data to us, such as your email, first name, last name, city of
                residence, organization, telephone number. You can choose not to provide us with
                your personal data, but then you may not be able to take advantage of some of the
                website's features. For example, you won't be able to receive our Newsletter or
                contact us directly from the website. Users who are uncertain about what information
